...
class NewLoadMovieData {
    ...
    fun getMoviesData(
        language: String, genres: List<Genres>, liveDataToObserve: MutableLiveData<AppState>,
    ) {
